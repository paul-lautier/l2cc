...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-VG5QBDTY.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-NNOGSKGZ.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-OMCU7ZBA.js");
...
//# sourceMappingURL=chunk-AGC6WMHL.js.map
